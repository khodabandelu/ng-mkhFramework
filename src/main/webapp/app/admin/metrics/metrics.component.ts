...
import { MkhMetricsMonitoringModalComponent } from './metrics-modal.component';
import { JhiMetricsService } from './metrics.service';

@Component({
    selector: 'mkh-metrics',
    templateUrl: './metrics.component.html'
})
export class MkhMetricsMonitoringComponent implements OnInit {
    metrics: any = {};
    cachesStats: any = {};
    servicesStats: any = {};
    ...
    refreshThreadDumpData() {
        this.metricsService.threadDump().subscribe(data => {
            const modalRef = this.modalService.open(MkhMetricsMonitoringModalComponent, { size: 'lg' });
