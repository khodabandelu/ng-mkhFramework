...
export const ROUTES: RouteInfo[] = [
    {
        ...
        submenu: [
            { path: '/admin/user-management', title: 'Users', icon: '', class: '', label: '', labelClass: '', extralink: false, submenu: [] },
    ...
    // {
    //     path: '', title: 'Personal', icon: '', class: 'nav-small-cap', label: 'dwdwdw', labelClass: 'has-arrow', extralink: true, submenu: []
    // },
    // {
